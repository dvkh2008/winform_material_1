...
namespace SKCT
{
    public partial class frmStatistical : Form
    {
        ...
        public void SytleDGridView()
        {
            ...
            DGridView.Columns[1].Width = 250;
            DGridView.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        ...
        private void RefreshPaging()
        {
            ...
            var total = string.IsNullOrEmpty(searchText) ? db.TotalOfStatisticalView() : db.TotalOfStatisticalSearchView(searchText);
        ...
        private void LoadDataToGird()
        {
            ...
            using var db = new DbContext();
            var data = string.IsNullOrEmpty(searchText) ? db.StatisticalViews.Get(pageSize, pageNo - 1): db.StatisticalSearchViews.SearchWithEnterprise(searchText, true, pageSize, pageNo - 1);
